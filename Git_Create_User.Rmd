...
* To install most programs at your NIVA computer you need administrative rights. To get that you need contact it-vakt (it-vakt@niva.no) and ask for administrative rights to your computer. You will shortly get an email with the username and password you need for installation. Then please follow the instructions on [Chapter 6 Install Git]( https://happygitwithr.com/install-git.html) of Jenny Bryan’s [Happy Git and GitHub for the useR (happygitwithr.com)](happygitwithr.com).